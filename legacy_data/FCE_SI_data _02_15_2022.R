...
jags.TS3 <- run_model(run="extreme", mix, source, discr, model_filename,
                             alpha.prior = 1, resid_err=F, process_err=T)
...
#                              Mean    SD  2.5%    5%   25%   50%
#p.dry19.Epiphytic microalgae 0.545 0.152 0.272 0.305 0.438 0.535
#p.wet19.Epiphytic microalgae 0.485 0.186 0.191 0.219 0.335 0.466
#p.dry19.Mangrove             0.278 0.097 0.061 0.095 0.217 0.289
#p.wet19.Mangrove             0.294 0.100 0.045 0.093 0.237 0.315
#p.dry19.Phytoplankton        0.177 0.091 0.020 0.036 0.106 0.176
#p.wet19.Phytoplankton        0.222 0.114 0.012 0.025 0.135 0.230
