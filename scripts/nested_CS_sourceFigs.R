...
ggsave("figures/CS/CS_Source_SRS_wide.png", width = 12, height = 4, dpi = 600)
...
ggsave("figures/CS/CS_Source_TS_tall.png", width = 4, height = 10, dpi = 600)
...
ggsave("figures/CS/CS_Source_TS_wide.png", width = 15, height = 4, dpi = 600)
