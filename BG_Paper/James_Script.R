...
# updated data as of July 2023 includes sulfur reruns and dry 2020 supplamental values
SI <- read.csv("data/FCE_SI_data_xls_11_July_2023_Sturges_edits.csv",na.strings=c("","NA"))%>%filter(is.na(outlier))
