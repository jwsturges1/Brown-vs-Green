...
cn_plot
ggsave("figures/CS/CN_biplots.png", cn_plot, units = "in", width = 18, height = 15)

cs_plot
ggsave("figures/CS/CS_biplots.png", cs_plot, units = "in", width = 18, height = 15)
...
ggsave("figures/CS/CN_biplots_fixed.png", cn_plot_standard_axes, units = "in", width = 18, height = 15)

cs_plot_standard_axes
ggsave("figures/CS/CS_biplots_fixed.png", cs_plot_standard_axes, units = "in", width = 18, height = 15)